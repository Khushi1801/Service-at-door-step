		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h3 class="page-title">Wallet Pending Request</h3>
						</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							...
							$sql = "SELECT * FROM `wallet_request` WHERE request_status = 'pending'";
							...
							$result = mysqli_query($conn,$sql) or die("query unsuccessful");
									...
									?>
												...
												<td>
													<a href="process/wallet_approved_data.php?index=<?php echo $row['wallet_request_id']?>">
													<span class="badge badge-success inv-badge
													p-2" style="font-size:15px;">Approve</span></a>
												</td>

												<td>
													<a href="process/wallet_reject_data.php?index=<?php echo $row['wallet_request_id']?>">
