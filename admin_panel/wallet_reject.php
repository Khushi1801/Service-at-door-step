		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h3 class="page-title">Wallet Request Rejected List</h3>
						</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							...
							$sql = "SELECT * FROM `wallet_request` WHERE request_status = 'reject'";
							...
							$result = mysqli_query($conn,$sql) or die("query unsuccessful");
									 ...
									 while($row = $result->fetch_assoc()){
										...
										$mobile_no = $member['mobile_no'];
									 	...
									 	{
									 	$id1 = $_SESSION['provider_wallet_id'];
